...
define("commonjs/fs/index", ["require", "exports", "commonjs/fs/json"], function (require, exports, json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
                ...
                fromJson(json) {
                    switch (json.type) {
                        ...
                        case LinkEntry.DIRECTORY:
                            return { type: LinkEntry.DIRECTORY, children: children.fromJson(json.children) };
                        case LinkEntry.PATH:
                            return { type: LinkEntry.PATH, path: json_1.JsonFormat.string().fromJson(json.value) };
                    }
                },
                toJson(entry) {
                    switch (entry.type) {
                        ...
                        case LinkEntry.DIRECTORY:
                            return { type: LinkEntry.DIRECTORY, children: children.toJson(entry.children) };
                    }
                }
            };
            children = json_1.JsonFormat.map(json_1.JsonFormat.string(), json_1.JsonFormat.defer(() => result));
            return result;
        }
        LinkEntry.json = json;
                ...
                switch (entry.type) {
                    ...
                    case LinkEntry.LINK:
                        if (resolveLink || i < path.length - 1) {
                            ({ entry, path: resolvedPath } = this.lookup(entry.path, resolveLink));
                            continue;
                        }
                        return { entry, path };
                    case LinkEntry.PATH:
    ...
    class LinkFs {
        ...
        entry(path) {
            ...
            if (resolved.entry.type === LinkEntry.LINK) {
                return { type: LinkEntry.LINK, path: [...mount.root, ...resolved.path] };
            }
...
define("nodejs/shim/fs", ["require", "exports", "url", "fs", "stream", "path", "commonjs/fs/index"], function (require, exports, url_1, fs, stream_1, path_1, commonjs_fs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("nodejs/runfile/init", ["require", "exports", "fs"], function (require, exports, fs) {
    "use strict";
    ...
    class ManifestRunfiles {
        ...
        addRunfile(name, path) {
            __classPrivateFieldGet(this, _ManifestRunfiles_pathByName, "f").set(name, path);
        }
        getPath(name) {
            if (name.startsWith("../")) {
            ...
            const path = __classPrivateFieldGet(this, _ManifestRunfiles_pathByName, "f").get(name);
            if (!path) {
...
define("nodejs/shim/index", ["require", "exports", "fs", "commonjs/fs/index", "nodejs/shim/fs", "nodejs/runfile/init"], function (require, exports, fs, commonjs_fs_2, fs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
